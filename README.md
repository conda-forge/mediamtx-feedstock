...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/mediamtx-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/mediamtx-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
It is possible to list all of the versions of `mediamtx` available on your platform:
...
```
pixi search mediamtx --channel conda-forge
```
